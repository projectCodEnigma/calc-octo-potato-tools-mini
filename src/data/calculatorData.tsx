...
import PennyDoublesCalculator from '../components/calculators/PennyDoublesCalculator';
...
export const calculatorData: Calculator[] = [
  ...
  {
    id: 'penny-doubles',
    name: 'Penny Doubles Daily Calculator',
    description: 'See how a penny grows when it doubles every day - exponential growth demo',
    category: 'finance',
    color: 'bg-green-500',
    component: PennyDoublesCalculator
  },
